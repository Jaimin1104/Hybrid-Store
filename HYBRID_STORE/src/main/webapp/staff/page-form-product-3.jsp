...
<section class="content-main" style="max-width:1200px">
    ...
    <div class="content-header">
        ...
        <div>
            <a href="#" class="btn btn-light">Save to draft</a>
            <a href="#" class="btn btn-primary">Publish now</a>
        </div>
    </div>
        ...
        <aside class="col-xl-4 col-lg-4">
            <div class="card mb-4">
                <div class="card-body">
                        ...
                        <a href="#" class="btn btn-sm btn-light mb-1">Woman 
                            <i class="material-icons md-close"></i></a>
                        <a href="#" class="btn btn-sm btn-light mb-1">Summer 
                            <i class="material-icons md-close"></i></a>
                        <a href="#" class="btn btn-sm btn-light mb-1">Clothes 
                            <i class="material-icons md-close"></i></a>
                        <hr>
