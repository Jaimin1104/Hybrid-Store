...
<body>
		...
		<div class="container">
            ...
            <img src="images/logo.png" alt="logo">
						...
						<form class="text-left clearfix" action="LoginController"
							...
							<p align="center">Verification code has been sent to your
								registered email address.</p>
							<div class="form-group">
								<input type="text"
									name="verification code" class="form-control"
									placeholder="Verification code">
								<div class="invalid-feedback"></div>
							</div>
							<div class="text-center">
								<input type="submit" name="btn" value="Verify code"
									autocapitalize="none" class="btn btn-primary">
							</div>
						</form>
						<p class="mt-3">
							<a onclick="LoginController">Resend code</a>
						</p>
	...
	<script>
		function validateForm() {
			...
			// Code Validation
			var enteredCode = document.getElementsByName("verification code");
			var codepattern = /^[0-9]\d{5}$/;
			if(enteredCode[0].value == null || enteredCode[0].value == "")
			{
				invalidFeedback[0].innerHTML = "OTP Can't be empty";
				$(enteredCode[0]).addClass("is-invalid");
				result = false;
			}
			else if(codepattern.test(enteredCode[0].value) == false)
			{
			...
			else
			{
				...
				$(enteredCode[0]).removeClass("is-invalid");
				//$(enteredCode[0]).addClass("is-valid");
				result = true;
			}
			return result;
		}
