							...
							<div class="col-md-4">
								<form action="../CategoriesController" method="post">
									<div class="mb-4">
										...
										<input type="text" name="categoryname" placeholder="Type here" class="form-control" required="required"/>
									</div>
									<div class="mb-4">
										<label class="form-label">Description</label>
										<textarea name="description" placeholder="Type here" class="form-control" rows="4" required="required"></textarea>
									</div>
									<div class="d-grid">
										<button class="btn btn-primary" name="btn" value="add category">Create</button>
									</div>
								</form>
							</div>
							<div class="col-md-8" style="height: 40vh; overflow-y: scroll;">
...
%>
										<tr>
											...
											<td><b><%=category.getCategoryname()%></b></td>
											<td><%=category.getDescription()%></td>
											<!-- <td>/men</td>
											<td>1</td> -->
											<td class="text-center">
												<div class="dropdown">
													<button onclick="deleteCategory(<%=category.getCategoryid()%>)" class="btn btn-outline-danger">Delete</button>
												</div> <!-- dropdown //end -->
											</td>
										</tr>
<%
...
%>
						...
						<div class="modal-content" data-tor="show(p):{scale.from(75) fade.in} quad">
							...
							<div class="modal-footer">
								<form method="post" action="../CategoriesController">
									...
									<button type="submit" name="btn" value="delete category" class="btn mb-2 btn-danger">Delete</button>
		...
		<script type="text/javascript">
			...
			{
				$('#confirmDelete #categoryid').val(categoryid);
