				...
				<div class="card-body">
					<div
						...
						<div class="col">
							<div class="card card-user">
								<div class="card-header">
									<img class="img-md img-avatar" src="images/people/avatar1.jpg"
										alt="User pic">
								</div>
								<div class="card-body">
						...
						<div class="col">
							<div class="card card-user">
								<div class="card-header">
									<img class="img-md img-avatar" src="images/people/avatar2.jpg"
										alt="User pic">
								</div>
								<div class="card-body">
						...
						<div class="col">
							<div class="card card-user">
								<div class="card-header">
									<img class="img-md img-avatar" src="images/people/avatar3.jpg"
										alt="User pic">
								</div>
								<div class="card-body">
									<h5 class="card-title mt-5">Leslie Alexander</h5>
						...
						<div class="col">
							<div class="card card-user">
								<div class="card-header">
									<img class="img-md img-avatar" src="images/people/avatar4.jpg"
										alt="User pic">
								</div>
								<div class="card-body">
