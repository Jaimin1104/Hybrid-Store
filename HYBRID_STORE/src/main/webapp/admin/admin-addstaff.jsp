<%@page import="hybridstore.model.AdminModel"%><%@page import="java.util.ArrayList"%>
...
%>
			...
			<section class="content-main" style="max-width: 1200px">
				<div class="content-header">
					<h2 class="content-title">New Staff Member</h2>
					<div>
						<a href="admin-addstaff.jsp" class="btn btn-outline-danger">&times; Discard</a>
					</div>
				</div>
				<div class="card mb-4">
					<div class="card-body">
						<form action="../StaffController" enctype="multipart/form-data" method="post" onsubmit="return validateForm()">
							<div class="mb-4 form-group">
								<label for="staff_firstname" class="form-label">First Name</label>
								<input type="text" class="form-control" name="firstname" placeholder="First Name">
								<div class="invalid-feedback"></div>
							</div>
							<div class="mb-4 form-group">
								<label for="staff_lastname" class="form-label">Last Name</label>
							...
							<div class="mb-4 form-group">
								<label for="staff_branchname" class="form-label"> Branch Name </label> 
								<select class="form-select" name="brachname">
...
<%
	...
	{
%>
									<option><%=branch.getBranchname()%></option>
<%
	}
%>
								</select>
							...
							<div class="mb-4 form-group">
								<label for="staff_profilepicture" class="form-label">Profile Picture</label>
								<input class="form-control" type="file" name="profilepicture">
							</div>
							<div class="text-left">
								<input type="submit" name="btn" value="Add Staff Member" class="btn btn-primary">
							</div>
						</form>
					</div>
				</div>
		...
		  	const password = document.querySelector('#inputPassword');
			...
			function validateForm() {
				...
				{
					invalidFeedback[3].innerHTML = "Age must be greater than 18";
					$(dob[0]).addClass("is-invalid");
					result = false;
		        }
				else if (dtCurrent.getFullYear() - dtDOB.getFullYear() == 18) 
				...
				// Branch Validation
				var branch = document.getElementsByName("brachname");
				if(branch[0].value == "Select Branch")
				{
					invalidFeedback[8].innerHTML = "Please select branch of staff member";
					$(branch[0]).addClass("is-invalid");
					result = false;
				}
				else
				{
					invalidFeedback[8].innerHTML = "";
					$(branch[0]).removeClass("is-invalid");
					//$(branch[0]).addClass("is-valid");
					result = true;
				}
				allresult.push(result);
