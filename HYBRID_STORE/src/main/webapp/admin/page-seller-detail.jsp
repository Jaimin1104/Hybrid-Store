				...
				<div class="card-body">
					<div class="row">
						<div class="col-xl col-lg flex-grow-0" style="flex-basis: 230px">
							<div
								...
								<img src="images/brands/brand.jpg" class="center-xy img-fluid"
									alt="Logo Brand">
							</div>
						</div>
						<!--  col.// -->
						...
						<div class="col-xl-4 text-md-end">
							...
							</select> <a href="#" class="btn btn-outline-primary"> View live <i
					...
					<div class="row g-4">
						...
						<div class="col-sm-6 col-lg-4 col-xl-3">
							<h6>Contacts</h6>
							<p>
								Manager: Jerome Bell <br> info@example.com <br> (229)
								555-0109, (808) 555-0111
							</p>
						</div>
						<!--  col.// -->
						<div class="col-sm-6 col-lg-4 col-xl-3">
							<h6>Address</h6>
							<p>
								Country: California <br> Address: Ranchview Dr. Richardson
								<br> Postal code: 62639
							</p>
						</div>
						<!--  col.// -->
						<div class="col-sm-6 col-xl-4 text-xl-end">
							<map class="mapbox position-relative d-inline-block">
								<img src="images/misc/map.jpg" class="rounded" height="120"
									alt="map">
					...
					<div class="row">
						<div class="col-xl-3 col-lg-4 col-md-6">
							<div class="card card-product-grid">
								<a href="#" class="img-wrap"> <img src="images/items/1.jpg"
									alt="Product">
								</a>
								<div class="info-wrap">
						...
						<div class="col-xl-3 col-lg-4 col-md-6">
							<div class="card card-product-grid">
								<a href="#" class="img-wrap"> <img src="images/items/2.jpg"
									alt="Product">
								</a>
								<div class="info-wrap">
						...
						<div class="col-xl-3 col-lg-4 col-md-6">
							<div class="card card-product-grid">
								<a href="#" class="img-wrap"> <img src="images/items/3.jpg"
									alt="Product">
								</a>
								<div class="info-wrap">
						...
						<div class="col-xl-3 col-lg-4 col-md-6">
							<div class="card card-product-grid">
								<a href="#" class="img-wrap"> <img src="images/items/5.jpg"
									alt="Product">
								</a>
								<div class="info-wrap">
									<a href="#" class="title">Just another product name</a>
						...
						<div class="col-xl-3 col-lg-4 col-md-6">
							<div class="card card-product-grid">
								<a href="#" class="img-wrap"> <img src="images/items/6.jpg"
									alt="Product">
								</a>
								<div class="info-wrap">
									<a href="#" class="title">Just another product name</a>
						...
						<div class="col-xl-3 col-lg-4 col-md-6">
							<div class="card card-product-grid">
								<a href="#" class="img-wrap"> <img src="images/items/7.jpg"
									alt="Product">
								</a>
								<div class="info-wrap">
									<a href="#" class="title">Just another product name</a>
						...
						<div class="col-xl-3 col-lg-4 col-md-6">
							<div class="card card-product-grid">
								<a href="#" class="img-wrap"> <img src="images/items/8.jpg"
									alt="Product">
								</a>
								<div class="info-wrap">
