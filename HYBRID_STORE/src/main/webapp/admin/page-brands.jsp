				...
				<div class="card-body">
					<div class="row gx-3">
						<div class="col-xl-2 col-lg-3 col-md-4 col-6">
							<figure class="card border-1">
								<div class="card-header bg-white text-center">
									<img height="76" src="images/brands/1.png" class="img-fluid"
										alt="Logo">
								</div>
						...
						<div class="col-xl-2 col-lg-3 col-md-4 col-6">
							<figure class="card border-1">
								<div class="card-header bg-white text-center">
									<img height="76" src="images/brands/2.png" class="img-fluid"
										alt="Logo">
								</div>
								<figcaption class="card-body text-center">
						...
						<div class="col-xl-2 col-lg-3 col-md-4 col-6">
							<figure class="card border-1">
								<div class="card-header bg-white text-center">
									<img height="76" src="images/brands/4.png" class="img-fluid"
										alt="Logo">
								</div>
								<figcaption class="card-body text-center">
						...
						<div class="col-xl-2 col-lg-3 col-md-4 col-6">
							<figure class="card border-1">
								<div class="card-header bg-white text-center">
									<img height="76" src="images/brands/5.png" class="img-fluid"
										alt="Logo">
								</div>
								<figcaption class="card-body text-center">
						...
						<div class="col-xl-2 col-lg-3 col-md-4 col-6">
							<figure class="card border-1">
								<div class="card-header bg-white text-center">
									<img height="76" src="images/brands/6.png" class="img-fluid"
										alt="Logo">
								</div>
								<figcaption class="card-body text-center">
						...
						<div class="col-xl-2 col-lg-3 col-md-4 col-6">
							<figure class="card border-1">
								<div class="card-header bg-white text-center">
									<img height="76" src="images/brands/7.png" class="img-fluid"
										alt="Logo">
								</div>
								<figcaption class="card-body text-center">
									<h6 class="card-title m-0">Acer</h6>
						...
						<div class="col-xl-2 col-lg-3 col-md-4 col-6">
							<figure class="card border-1">
								<div class="card-header bg-white text-center">
									<img height="76" src="images/brands/8.png" class="img-fluid"
										alt="Logo">
								</div>
								<figcaption class="card-body text-center">
						...
						<div class="col-xl-2 col-lg-3 col-md-4 col-6">
							<figure class="card border-1">
								<div class="card-header bg-white text-center">
									<img height="76" src="images/brands/9.png" class="img-fluid"
										alt="Logo">
								</div>
								<figcaption class="card-body text-center">
						...
						<div class="col-xl-2 col-lg-3 col-md-4 col-6">
							<figure class="card border-1">
								<div class="card-header bg-white text-center">
									<img height="76" src="images/brands/10.png" class="img-fluid"
										alt="Logo">
								</div>
								<figcaption class="card-body text-center">
						...
						<div class="col-xl-2 col-lg-3 col-md-4 col-6">
							<figure class="card border-1">
								<div class="card-header bg-white text-center">
									<img height="76" src="images/brands/3.png" class="img-fluid"
										alt="Logo">
								</div>
								<figcaption class="card-body text-center">
									<h6 class="card-title m-0">Company name</h6>
