	...
	<main>
		...
		<section class="content-main">
			...
			<div class="card shadow mx-auto"
				style="max-width: 380px; margin-top: 60px;">
				<div class="card-body">
					...
					<form>
						...
						<div class="mb-3">
							<label class="form-label">Email</label> <input
								class="form-control" placeholder="Type email" type="text">
						</div>
						<!-- form-group// -->
						<div class="mb-3">
						...
						<!-- form-group// -->
						<div class="mb-3">
							<label class="form-label">Create password</label> <input
								class="form-control" placeholder="Password" type="password">
						</div>
						<!-- form-group// -->
						<div class="mb-3">
							<p class="small text-center text-muted">By signing up, you
								confirm that you’ve read and accepted our User Notice and
								Privacy Policy.</p>
						</div>
						<!-- form-group  .// -->
						<div class="mb-4">
					...
					<div class="d-flex gap-2 mb-4">
						<a href="#" class="w-50 btn btn-light"> <svg
								aria-hidden="true" class="icon-svg"
								style="vertical-align: bottom; margin-top: -4px;" width="20"
                  ...
                  <path
						...
						</a> <a href="#" class="w-50 btn btn-light"> <svg
