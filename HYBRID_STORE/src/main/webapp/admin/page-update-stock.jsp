							...
							<form>
								<div class="mb-4">
									<label for="product_name" class="form-label">Name</label> <input
										type="text" value="Shoes" readonly="readonly"
										class="form-control" />
								</div>
								<div class="mb-4">
									<label for="product_brand" class="form-label">Brand</label> <input
										type="text" value="puma" readonly="readonly"
										class="form-control" />
								</div>
								<div class="mb-4">
									<label for="product_subcategory" class="form-label">Subcategory</label>
									<input type="text" value="Men-Shoes" readonly="readonly"
										class="form-control" />
								</div>
								<div class="mb-4">
									<label for="product_category" class="form-label">Category</label>
									<input type="text" value="Men" readonly="readonly"
										class="form-control" />
								</div>
								<div class="mb-4">
									<label for="product_price" class="form-label">Price</label> <input
										type="text" value="2000" readonly="readonly"
										class="form-control" />
								</div>
								<div class="mb-4">
									<input type="text" value="101" hidden="true"
										class="form-control" />
								</div>
								<div class="mb-4">
