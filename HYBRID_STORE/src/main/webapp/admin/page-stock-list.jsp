	...
	<main class="main-wrap">
		...
		<section class="content-main">
			...
			<div class="content-header">
				...
				<div>
					<a href="page-update-stock.jsp" class="btn btn-primary"><i
						class="material-icons md-plus"></i> Update Stock</a>
				</div>
			</div>
						...
						<div class="row align-items-center">
							...
							<div class="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name">
								<a class="itemside" href="#">
									<div class="left">
										<img src="images/items/1.jpg" class="img-sm img-thumbnail"
											alt="Item">
									</div>
									<div class="info">
							...
							<div class="col-lg-2 col-sm-2 col-5 col-stock">
								<span>100</span>
							</div>
					...
					<article class="itemlist">
						<div class="row align-items-center">
							...
							<div class="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name">
								<a class="itemside" href="#">
									<div class="left">
										<img src="images/items/2.jpg" class="img-sm img-thumbnail"
											alt="Item">
									</div>
									<div class="info">
					...
					<article class="itemlist">
						<div class="row align-items-center">
							...
							<div class="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name">
								<a class="itemside" href="#">
									<div class="left">
										<img src="images/items/3.jpg" class="img-sm img-thumbnail"
											alt="Item">
									</div>
									<div class="info">
					...
					<article class="itemlist">
						<div class="row align-items-center">
							...
							<div class="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name">
								<a class="itemside" href="#">
									<div class="left">
										<img src="images/items/4.jpg" class="img-sm img-thumbnail"
											alt="Item">
									</div>
									<div class="info">
					...
					<article class="itemlist">
						<div class="row align-items-center">
							...
							<div class="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name">
								<a class="itemside" href="#">
									<div class="left">
										<img src="images/items/5.jpg" class="img-sm img-thumbnail"
											alt="Item">
									</div>
									<div class="info">
					...
					<article class="itemlist">
						<div class="row align-items-center">
							...
							<div class="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name">
								<a class="itemside" href="#">
									<div class="left">
										<img src="images/items/6.jpg" class="img-sm img-thumbnail"
											alt="Item">
									</div>
									<div class="info">
