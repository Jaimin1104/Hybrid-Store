	...
	<main class="main-wrap">
		...
		<section class="content-main">
			...
			<div class="content-header">
				...
				<div>
					<a href="#" class="btn btn-light">Export</a> <a href="#"
						class="btn btn-light">Import</a> <a href="#"
					...
					<div
						...
						<div class="col">
							<div class="card card-product-grid">
								...
								<div class="info-wrap">
									<a href="#" class="title text-truncate">Just another
										product name</a>
						...
						<div class="col">
							<div class="card card-product-grid">
								...
								<div class="info-wrap">
									<a href="#" class="title text-truncate">Brown Winter Jacket
										for Men</a>
									<div class="price mb-2">$179.00</div>
									<!-- price.// -->
						...
						<div class="col">
							<div class="card card-product-grid">
								...
								<div class="info-wrap">
									<a href="#" class="title text-truncate">Jeans short new
										model</a>
									<div class="price mb-2">$179.00</div>
									<!-- price.// -->
						...
						<div class="col">
							<div class="card card-product-grid">
								...
								<div class="info-wrap">
									<a href="#" class="title text-truncate">Apple Airpods
										CB-133</a>
									<div class="price mb-2">$179.00</div>
									<!-- price.// -->
