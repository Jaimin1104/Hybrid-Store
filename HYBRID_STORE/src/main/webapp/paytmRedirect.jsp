...
<%
String merchantMid = "oKomeA64569327910551";
//Key in your staging and production MID available in your dashboard
String merchantKey = "aa1qhPlRNvLF6f_Y";
//Key in your staging and production merchant key available in your dashboard
String orderId = request.getParameter("orderid");
String channelId = "WEB";
String custId = "cust123";
String mobileNo = "9737482707";
String email = "patelmihir4029@gmail.com";
String txnAmount = request.getParameter("payment");
String website = "WEBSTAGING";
//This is the staging value. Production value is available in your dashboard
String industryTypeId = "Retail";
//This is the staging value. Production value is available in your dashboard
String callbackUrl = "http://localhost:8080/HYBRID_STORE/paytmResponse.jsp";
